...
from network.mtcnn import PNetWithLoss
...
def parse_args():
    ...
    parser.add_argument('--anno_file', help='training data annotation file',
                        default="/root/xidian_wks/mtcnn/anno_strore/imglist_anno_12.txt", type=str)
...
if __name__ == '__main__':
    ...
    sys.exit()
    train_data = data_to_mindrecord_byte_image(gt_imdb, prefix="img12.mindrecord", file_num=1, mindrecord_dir=args.mindrecord_dir)
    """
    ...
    net_with_loss = PNetWithLoss(is_train=True)
    ...
    ckpt_cb = ModelCheckpoint(prefix='mtcnn_pnet',
