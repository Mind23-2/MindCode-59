...
from network.mtcnn import RNetWithLoss
...
def parse_args():
    ...
    parser.add_argument('--anno_file', help='training data annotation file',
                        default="/root/xidian_wks/mtcnn/anno_strore/imglist_anno_24.txt", type=str)
...
if __name__ == '__main__':
    ...
    train_data = data_to_mindrecord_byte_image(gt_imdb, prefix="img24.mindrecord", file_num=1, mindrecord_dir=args.mindrecord_dir)
    """
    ...
    mindrecord_file = "/root/xidian_wks/mtcnn/data_set/img24.mindrecord"
    ...
    net_with_loss = RNetWithLoss(is_train=True)
    ...
    ckpt_cb = ModelCheckpoint(prefix='mtcnn_rnet',
